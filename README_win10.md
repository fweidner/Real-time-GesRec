...
* Use venv to set up Python3. There is a requirements.txt. Here's a tutorial on how to do it: https://www.youtube.com/watch?v=APOPm01BVrk

## Quickstart w/ EgoGesture and online-testing
* Download Egogesture dataset
* Download "Pretrained_models_v1"
* Put 2egogesture_resnetl_10_Depth_8.pth" into the "results" folder
* Set "--root-path" to this repository
* Set "--video-path" to the root of the EgoGesture dataset
* Execute "run_online_ego.bat" (don't forget to activate the venv)
